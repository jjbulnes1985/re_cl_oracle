...
| **Auto-orquestador IP rotation** — `scripts/run_di_auto.py` detecta IP, prueba quota, scrape, intenta Cloudflare WARP automáticamente · Task Scheduler bat actualizado para usarlo · `prompts/vpn_free_alternatives.md` con 5 estrategias gratis (tethering / WARP / Oracle Cloud / café WiFi / reset módem) · `infra/oracle_cloud/main.tf` Terraform para 3 VMs Always Free | **Completado 2026-05-01** |
| **Sesión scraping con IP nueva** — 6 comunas completas + 1 partial en una sola sesión: Independencia 4101, Vitacura 11578, Talagante 657, Buin 1835, Melipilla 1899, Pirque 154, Cerrillos 1648 partial = ~22k rows nuevos. **Estado DI: 12/40 comunas** | **Completado 2026-05-01** |
